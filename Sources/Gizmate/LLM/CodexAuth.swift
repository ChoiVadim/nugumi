...
/// OAuth dance we mirror everything to ~/Library/Logs/Gizmate/codex.log
...
enum CodexDebugLog {
    ...
    private static let fileURL: URL = {
        let logs = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask)
            .first!
            .appending(path: "Logs/Gizmate", directoryHint: .isDirectory)
...
//
// Lets a user drive Gizmate with their Claude Pro/Max subscription instead of a
