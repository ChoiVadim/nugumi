...
struct OpenAICodexClient: LLMBackend {
    ...
    static func cloudflareHeaders(accessToken: String) -> [String: String] {
        var headers: [String: String] = [
            "User-Agent": "codex_cli_rs/0.0.0 (Gizmate)",
    ...
    func ask(
        ...
        let currentPrompt = AskGizmatePromptBuilder.prompt(question: cleanQuestion, hasImage: image != nil)
    ...
    private func performStreamingRequest(
        ...
        do {
            ...
            // upstream — be explicit about that so users don't think Gizmate
            // is broken.
            let message: String
