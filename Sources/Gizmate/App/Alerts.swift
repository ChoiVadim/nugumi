...
@MainActor
private final class GizmateModalPanel: NSPanel {
...
@MainActor
final class GizmateInputAlertController: NSWindowController, NSWindowDelegate {
...
final class GizmateAlertController: NSWindowController, NSWindowDelegate {
