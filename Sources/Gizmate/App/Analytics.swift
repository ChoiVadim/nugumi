...
final class AnalyticsClient {
    ...
    private static func configuredEndpoint(defaults: UserDefaults) -> URL? {
        ...
        if let raw = Bundle.main.object(forInfoDictionaryKey: "GizmatePostHogEndpoint") as? String,
    ...
    private static func configuredAPIKey(defaults: UserDefaults) -> String? {
        ...
        if let raw = Bundle.main.object(forInfoDictionaryKey: "GizmatePostHogAPIKey") as? String, !raw.isEmpty {
            return raw
        }
        return nil
    }
