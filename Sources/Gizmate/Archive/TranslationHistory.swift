...
/// What produced a history entry. Mirrors the translation modes plus Ask Gizmate.
enum HistoryKind: String, Codable, Equatable {
    ...
    var symbolName: String {
        ...
        case .askGizmate: return "sparkles"
        }
    }
...
/// Persisted feed of recent translations and Ask Gizmate turns, shown on Home.
...
final class TranslationHistoryStore: ObservableObject {
    ...
    // Pre-rename key on purpose — renaming it hides every existing user's history.
    ...
    func recordAsk(question: String, answer: String) {
        append(kind: .askGizmate, source: question, result: answer, targetLanguageID: nil)
    }
