...
enum NativeToolError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .badURL(let raw):
            return "That isn't a link Gizmo can open: \(raw)"
...
/// uv start plus an interpreter boot. It also needs no permission Gizmo doesn't
...
enum NativeToolRunner {
    ...
    static func run(_ tool: NugumiTool, context: ToolContext) async throws -> Result {
